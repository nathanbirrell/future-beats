      ...
      <div className="w-full flex flex-col h-screen justify-between">
          ...
          {show && (
            <Fragment>
              <div className="my-4 lg:mt-12">
                <div className="cover-art object-cover">
                  {show?.artwork && (
                    <img
                ...
                <h1 className="mt-2 text-xs text-gray-700">
                  {show.title} —{" "}
                  {show.published_at && relativeDateIfRecent(show.published_at)}
                </h1>
              </div>
        ...
        <footer className="pt-8 pb-4">
          <p className="text-xs opacity-90">
            <span>
              Made with ☕️ and Future Beats in Melbourne, Australia. Contribute
              at{" "}
              <a
